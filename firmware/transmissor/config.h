...
#define TANQUE_DIST_MIN_CM    10    // Distância quando a caixa está CHEIA (folga cega do sensor)
...
// ------------------------------------------------------------
#define TIMEOUT_LORA_DESLIGA_MS    45000UL // Se não receber pacote por 45s -> Desliga bomba (proteção estanque)
#define TEMPO_MAX_BOMBA_LIGADA_MIN 30      // Tempo máximo (minutos) da bomba ligada continuamente (proteção contra poço seco / transbordo)
#define TEMPO_MIN_PAUSA_BOMBA_MS   60000UL // Pausa mínima de 1 minuto entre religamentos (anti-cycling do motor)
...
#define INTERVALO_ENVIO_TX_MS 10000 // Intervalo de medição e envio no Transmissor (10s)
...
#define RELE_LOGICA_INVERSA    false  // Setar 'true' se o módulo relé acionar em LOW (lógica invertida comum em módulos optoacoplados)
...
#define MQTT_SERVER         "192.168.1.100"  // IP do Orange Pi na rede separada
